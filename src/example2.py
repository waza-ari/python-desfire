...
class MyObserver(CardObserver):
    ...
    def update(self, observable, actions):
        ...
        for card in addedcards:
            ...
            default_key_1 = desfire.createKeySetting(
                "00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00", 0, DESFireKeyType.DF_KEY_2K3DES, []
            )
            ...
            default_app_key = desfire.createKeySetting(
                "00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00", 0, DESFireKeyType.DF_KEY_AES, []
            )
            app_key = desfire.createKeySetting(
                "00 10 20 31 40 50 60 70 80 90 A0 B0 B0 A0 90 80", 0, DESFireKeyType.DF_KEY_AES, []
            )
            logger.info("Auth Key %d", 0)
            try:
            ...
            desfire.changeKeySettings(
                [
                    DESFireKeySettings.KS_ALLOW_CHANGE_MK,
                    DESFireKeySettings.KS_CONFIGURATION_CHANGEABLE,
                    DESFireKeySettings.KS_CHANGE_KEY_WITH_KEY_1,
                ]
            )
            app_key_1 = desfire.createKeySetting(
                "11 22 33 44 55 66 77 88 99 AA BB CC DD EE FF 00", 0, DESFireKeyType.DF_KEY_AES, []
            )
            ...
            app_key_2 = desfire.createKeySetting(
                "22 33 44 55 66 77 88 99 AA BB CC DD EE FF 00 11", 0, DESFireKeyType.DF_KEY_AES, []
            )
            logger.info("Cange Key %d", 2)
            desfire.changeKey(2, app_key_2, default_app_key)
            app_key_3 = desfire.createKeySetting(
                "33 44 55 66 77 88 99 AA BB CC DD EE FF 00 11 22", 0, DESFireKeyType.DF_KEY_AES, []
            )
            logger.info("Cange Key %d", 3)
            desfire.changeKey(3, app_key_3, default_app_key)
            app_key_4 = desfire.createKeySetting(
                "44 55 66 77 88 99 AA BB CC DD EE FF 00 11 22 33", 0, DESFireKeyType.DF_KEY_AES, []
            )
