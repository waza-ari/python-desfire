...
""")
    ...
    def createFile(self):
        ...
        filePerm.setPerm(
            int(input("Read key number: ")),
            int(intput("Write key number")),
        ...
        self.desfire.createStdDataFile(
            int(input("File id: ")), filePerm, int(input("File lenght: "))
        )  # file Id 0, length 32 byte

    def writeFile(self):
        self.desfire.writeFileData(
            int(input("File id: ")), int(input("Offset")), int(input("Length: ")), input("Data: ")
        )

    def readFile(self):
        print(
            byte_array_to_human_readable_hex(
                self.desfire.readFileData(int(input("File id: ")), int(input("Offset")), int(input("Length: ")))
            )
        )
